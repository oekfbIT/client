...
const data = [
  {
    title: "core Admin Title 1",
  },
  {
    title: "core Admin Title 2",
  },
  {
    title: "core Admin Title 3",
  },
  {
    title: "core Admin Title 4",
  },
];
    ...
    renderItem={(item) => (
      <List.Item>
        <List.Item.Meta
          ...
          description="core Design, a design language for background applications, is refined by Hypeople UED Team"
        />
      </List.Item>
    )}
  />
...
for (let i = 0; i < 23; i++) {
  listData.push({
    ...
    avatar: user,
    description:
      "core Design, a design language for background applications, is refined by Hypeople UED Team",
    content:
