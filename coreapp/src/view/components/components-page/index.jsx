      ...
      list: [
        {
          img: "typography.svg",
          title: "Style Guide",
          subtitle: "core UI Style with typography and colors.",
        ...
        },
        {
          img: "icon.svg",
          title: "Icons",
          subtitle: "Remix Icon for core Admin Template",
      ...
      >
        <Link to={item.link}>
          ...
          >
            <img
              src={
                require(`../../../assets/images/components/${item.img}`).default
                // require(`../../../assets/images/components/${item.img}`).default
              }
              alt={item.title}
            />
  ...
  return (
    <Row gutter={[0, 48]} className="hp-mb-48">
      <Col span={24}>
        <PageContent
          title="Components"
          desc="core Components has all ant components helps you create beautiful apps."
          breadcrumb={[
            {
              title: "Components",
